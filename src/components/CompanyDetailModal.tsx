...
export const CompanyDetailModal: React.FC<CompanyDetailModalProps> = ({
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5">
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-2.5">
                  ...
                  <strong className="text-sm text-blue-700 font-bold">
                    {consensus.nextQuarterEps !== undefined ? `${consensus.isConvertedToUsd ? '
                  </strong>
                </div>
                <div className="bg-white border border-slate-200 rounded-lg p-2.5">
                  <div className="flex items-center justify-between">
                  ...
                  <strong className="text-sm text-slate-900 font-bold block mt-0.5">
                    {formatRevenueBillions(consensus.nextQuarterRevenue, consensus.isConvertedToUsd ? '
                  ...
                  {consensus.nextQuarterRevenueLow !== undefined && consensus.nextQuarterRevenueHigh !== undefined && (
                    <span className="text-[10px] text-slate-400 font-mono-code block">
                      Range: {consensus.isConvertedToUsd ? '
                    </span>
                  )}
                </div>
              </div>
 ...
 : (isEuropeanCompany ? cur : consensus.targetCurrency || cur))}
                    {consensus.isConvertedToUsd && <span className="text-xs font-semibold text-amber-700 ml-1">USD</span>}
                  </strong>
                  {consensus.nextQuarterRevenueLow !== undefined && consensus.nextQuarterRevenueHigh !== undefined && (
                    <span className="text-[10px] text-slate-400 font-mono-code block">
 ...
 : (isEuropeanCompany ? cur : consensus.targetCurrency || cur)}{consensus.nextQuarterRevenueLow}B - {consensus.isConvertedToUsd ? '
                    </span>
                  )}
                </div>
              </div>
 ...
 : (isEuropeanCompany ? cur : consensus.targetCurrency || cur)}{consensus.nextQuarterRevenueHigh}B
                    </span>
                  )}
                </div>
              </div>
 ...
 : (isEuropeanCompany ? cur : consensus.targetCurrency || cur)}${consensus.nextQuarterEps.toFixed(2)}` : 'N/A'}
                  </strong>
                </div>
                <div className="bg-white border border-slate-200 rounded-lg p-2.5">
                  <div className="flex items-center justify-between">
