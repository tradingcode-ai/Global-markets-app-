...
export const STOCK_TECHNICAL_INDICATORS: Record<string, { high52: number; low52: number; dma200: number }> = {
  ...
  AMD: { high52: 227.30, low52: 94.04, dma200: 159.80 }, // Current ~154 -> BELOW 200 DMA
  CRM: { high52: 318.01, low52: 203.45, dma200: 274.50 },
  NFLX: { high52: 732.10, low52: 370.20, dma200: 628.70 },

  // European Tech Leaders
  ASML: { high52: 1069.78, low52: 725.10, dma200: 892.40 }, // Current ~845.50 -> BELOW 200 DMA
  ...
  IFX: { high52: 40.24, low52: 28.60, dma200: 34.80 }, // Current ~32.80 -> BELOW 200 DMA
  STM: { high52: 47.80, low52: 25.40, dma200: 36.90 }, // Current ~30.50 -> BELOW 200 DMA
  ...
  // European Financials & STOXX Index
...
export function getStockTechnicalMetrics(
  ticker: string, 
  currentPrice: number, 
  quote?: { fiftyTwoWeekHigh?: number; fiftyTwoWeekLow?: number; twoHundredDayAverage?: number }
): TechnicalMetrics {
